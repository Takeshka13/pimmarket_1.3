...
market.owner={
	{uuid="7a333ce7-04cb-3d4d-beb6-9864f3b438e7",name="Takeshi_13"}
}
market.shopLine=1
...
market.component = {'chest','iron','gold','diamond','crystal'}
...
market.button={
	eula1={x=5,xs=67,y=3,ys=1,text='Здравствуйте! Рады видеть вас!',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula2={x=5,xs=67,y=5,ys=1,text='Вас приветствует электронный магазин dp.',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula3={x=5,xs=67,y=7,ys=1,text='Все покупки в магазине производятся за Деньги.',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula4={x=5,xs=67,y=9,ys=1,text='Обменник эмов на Деньги стоит на /warp obmen -',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula5={x=5,xs=67,y=11,ys=1,text='сдача от покупки зачислится на dp-счёт игрока.',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula6={x=5,xs=67,y=13,ys=1,text='Этот счёт автоматически используется при последующих покупках.',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula7={x=5,xs=67,y=15,ys=1,text='Курс эмов к Деньгам составляет 1 к 1.',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula8={x=5,xs=67,y=17,ys=1,text='Все цены в магазине указаны в эмах.',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula9={x=5,xs=67,y=19,ys=1,text='Если вы согласны с предоставленными условиями пользования',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula10={x=5,xs=67,y=21,ys=1,text='подтвердите согласием',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	eula11={x=30,xs=19,y=24,ys=1,text='СОГЛАСЕН/СОГЛАСНА',tx=1,ty=0,bg=0xf2b233,fg=0x111111},
	eula12={x=51,xs=26,y=24,ys=1,text='discord автора:takeshi1911',tx=0,ty=0,bg=0x103010,fg=0xf2b233},
	eula13={x=1,xs=28,y=23,ys=1,text='по всем вопросам о товаре',tx=0,ty=0,bg=0x103010,fg=0xf2b233},
	eula14={x=1,xs=28,y=24,ys=1,text='пишите владельцу Takeshi_13',tx=0,ty=0,bg=0x103010,fg=0xf2b233},

	player={x=3,xs=10,y=1,ys=1,text='name',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	status={x=3,xs=10,y=2,ys=1,text='player',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	mode={x=3,xs=10,y=3,ys=1,text='trade',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	totalitems={x=1,xs=19,y=24,ys=1,text=tostring(#market.inumList)..'items',tx=1,ty=0,bg=0x303030,fg=0x9966cc},
	cashname={x=3,xs=10,y=5,ys=1,text='Деньги',tx=0,ty=0,bg=0x303030,fg=0x9966cc},
	cash={x=3,xs=10,y=6,ys=1,text='dp money:',tx=0,ty=0,bg=0x303030,fg=0x9966cc},
	balancename={x=3,xs=10,y=7,ys=1,text='dp-мани:',tx=0,ty=0,bg=0x303030,fg=0x9966cc},
	balance={x=3,xs=10,y=8,ys=1,text='lua coins:',tx=0,ty=0,bg=0x303030,fg=0x9966cc},
	ratio={x=3,xs=10,y=9,ys=1,text='1 Э = 1 Деньги',tx=0,ty=0,bg=0x303030,fg=0x9966cc},

	one={x=17,xs=6,y=4,ys=3,text='1',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	two={x=25,xs=6,y=4,ys=3,text='2',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	free={x=33,xs=6,y=4,ys=3,text='3',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	foo={x=17,xs=6,y=8,ys=3,text='4',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	five={x=25,xs=6,y=8,ys=3,text='5',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	six={x=33,xs=6,y=8,ys=3,text='6',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	seven={x=17,xs=6,y=12,ys=3,text='7',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	eight={x=25,xs=6,y=12,ys=3,text='8',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	nine={x=33,xs=6,y=12,ys=3,text='9',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	zero={x=25,xs=6,y=16,ys=3,text='0',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	back={x=17,xs=6,y=16,ys=3,text='<-',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	dot={x=33,xs=6,y=16,ys=3,text='.',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	enternumber={x=33,xs=6,y=16,ys=3,text='OK',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	set={x=41,xs=6,y=16,ys=3,text='ok',tx=2,ty=1,bg=0x303030,fg=0x9966cc},

	number={x=41,xs=12,y=8,ys=3,text='',tx=10,ty=1,bg=0x303030,fg=0x9966cc},
	select={x=41,xs=24,y=4,ys=3,text='item',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	totalprice={x=41,xs=12,y=12,ys=3,text='',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	incorrect={x=41,xs=20,y=12,ys=3,text='нехватка средств',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	buyCancel={x=12,xs=45,y=10,ys=3,text='Извините, товар кончился. Вычтенные средства возвращены',tx=2,ty=1,bg=0x303030,fg=0x9966cc},

	newname={x=26,xs=4,y=16,ys=3,text='newname',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	acceptbuy={x=41,xs=24,y=16,ys=3,text='подтвердить',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	cancel={x=34,xs=10,y=24,ys=1,text='отмена',tx=2,ty=0,bg=0x303030,fg=0x9966cc},
	search={x=48,xs=10,y=24,ys=1,text='поиск',tx=2,ty=0,bg=0x303030,fg=0x9966cc},
	searchInput={x=60,xs=10,y=24,ys=1,text='Найти:',tx=2,ty=0,bg=0x303030,fg=0x9966cc},

	welcome={x=24,xs=32,y=12,ys=3,text='добро пожаловать в dp market',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	name={x=32,xs=24,y=8,ys=3,text='name',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	wait={x=27,xs=24,y=16,ys=3,text='ждём ответ сервера...',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	entrance={x=3,xs=72,y=2,ys=22,text='',tx=1,ty=1,bg=0x141414,fg=color.blackLime},
	pim1={x=26,xs=24,y=6,ys=12,text='',tx=1,ty=1,bg=0x404040,fg=0x9966cc},
	pim2={x=28,xs=20,y=7,ys=10,text='Встаньте на PIM',tx=2,ty=4,bg=0x202020,fg=0x9966cc},
	buy={x=30,xs=16,y=8,ys=3,text='Купить',tx=5,ty=1,bg=0x303030,fg=0x9966cc},
	sell={x=30,xs=16,y=12,ys=3,text='Продать',tx=5,ty=1,bg=0x303030,fg=0x9966cc},
	full={x=16,xs=39,y=10,ys=3,text='Ваш инвентарь полон. Доступ закрыт.',tx=2,ty=1,bg=0x303030,fg=0x9966cc},
	
	shopUp={x=3,xs=10,y=12,ys=5,text='ВВЕРХ',tx=2,ty=2,bg=0x303030,fg=0x9966cc},
	shopDown={x=3,xs=10,y=18,ys=5,text='ВНИЗ',tx=3,ty=2,bg=0x303030,fg=0x9966cc},
	shopTopRight={x=21,xs=55,y=1,ys=1,text='Available items                           к-во  цена',tx=0,ty=0,bg=0xc49029,fg=0x000000},
	shopFillRight={x=21,xs=40,y=2,ys=20,text='',tx=0,ty=0,bg=0x303030,fg=0x9966cc},
